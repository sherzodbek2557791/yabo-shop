    ...
    <header>
      <div class="container no-padding">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
          ...
          <div class="logo">
            <router-link to='/'>
              <img src="./assets/images/logo/main.png" style="object-fit: contain; width: 164px; height: 70px;">
            </router-link>
          </div><!-- /.logo -->
          <!-- ============================================================= LOGO : END ============================================================= -->
        </div><!-- /.logo-holder -->
          ...
          <div class="search-area">
            <form>
              <div class="control-group">
                <input class="search-field" :placeholder="$t('app.search')" />
                <ul class="categories-filter animate-dropdown">
                  <li class="dropdown">
                    <el-dropdown trigger="click">
                      <span class="dropdown-toggle">{{ $t('app.allCategories') }}</span>
                      <el-dropdown-menu slot="dropdown">
                        <router-link to="/blog"><el-dropdown-item>Home</el-dropdown-item></router-link>
                        <el-dropdown-item>laptops</el-dropdown-item>
                        <el-dropdown-item>tv & audio</el-dropdown-item>
                        <el-dropdown-item>gadgets</el-dropdown-item>
                        <el-dropdown-item>cameras</el-dropdown-item>
                      </el-dropdown-menu>
                    </el-dropdown>
                  </li>
                </ul>
...
<!--                      <span class="sign">$</span><span class="value">3219,00</span>-->
  ...
  <!--<div id="app">
   nav>
     ...
     <router-link to='/hello_world'>hello_world</router-link>
   </nav>
   <router-view></router-view>
